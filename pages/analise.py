...
# Function to load data without parsing dates for initial inspection
@st.cache_data
...
if inspected_data is not None:
    ...
    # Display columns of inspected data
    ...
    def load_and_normalize_data(file_path):
        try:
            ...
            data['Price'].fillna(data['Price'].mean(), inplace=True)  # Fill missing values with mean
            return data
        except Exception as e:
